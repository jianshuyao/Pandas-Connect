               ...
               <mdb-row md="4" center>
                  <mdb-modal-footer center>
                     <mdb-col center>
                        ...
                        <mdb-row md="4" center>
                          <button type="button" class="btn btn-outline-warning waves-effect btn-lg" style="font-size:20px">Faculty</button>
                          <button type="button" class="btn btn-outline-warning waves-effect btn-lg" style="font-size:20px">Module</button>


                           <div class="input-group md-form form-sm form-2 pl-0">
                            <input class="form-control my-0 py-1 red-border" type="text" placeholder="Search Faculty" aria-label="Search" style="font-size: 25px;">
