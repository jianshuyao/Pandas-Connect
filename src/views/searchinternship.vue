      ...
      <section class="mt-lg-5">
        ...
        <mdb-row md="6" center>
          <p style="font-size:18px">
            <i>Advanced Analytics brought to you by The Pandas</i>
          </p>
          <br /><br />
        </mdb-row>
        <mdb-row md="6" center>
          <mdb-col col="3">
            ...
            >
              <option selected="selected" disabled class="placeholder" value="">
                Choose Your Major</option
              >
              <option v-for="internship in internship_list" :key="internship">{{
                internship
              }}</option>
            </select>
          </mdb-col>
          ...
          <mdb-col col="3">
            ...
            <input
              ...
              list="suggestions"
              style="width:350px;height:40px;"
              placeholder=" Choose Your Internship of Interest"
              v-model="car"
            />
          </mdb-col>
        </mdb-row>
...
export default {
  ...
  mounted() {
    db.ref("/majname/major")
      ...
      .then(snapshot => {
        this.internship_list = snapshot.val();
      });
    db.ref("/majwithintern/")
      .once("value") //need smaller dataset to quicken loading
      .then(snapshot => {
